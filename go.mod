module github.com/sebarcode/laporan
...
require (
	git.kanosolution.net/kano/dbflex v1.3.5
...
require (
	...
	github.com/ariefdarmawan/datahub v0.3.2-0.20240125023907-458b82022698 // indirect
